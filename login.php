            ...
            <div class=" custom-form p-5 pb-0 custom-border">
              ...
              <form method="post" onsubmit="">
               ...
               <div class="text-center">
                ...
                <p class="text-center text-muted mt-2">Dont' have an account? 
</br><a href="registration.php" class="fw-bold text-body"><u>Register here</u></a></p>
<p class="text-center text-muted"><span style="color:red;">*</span>Please Login to continue </p>
              </form>
